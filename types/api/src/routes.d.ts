...
export declare class DaemonRoutes {
    ...
    operatorShow(canvasId: string, proof: string): Promise<OperatorShowResponse>;
    /** The ledger, newest first — the operator reads it and nobody else does. */
    operatorLog(proof: string, options?: {
        target?: string | null;
        limit?: number;
     ...
     */
    operatorEnd(target: string, proof: string, request: OperatorEndRequest): Promise<OperatorEndResponse>;
    /**
     ...
     */
    operatorRevoke(target: string, proof: string, request: OperatorRevokeRequest): Promise<OperatorRevokeResponse>;
    /**
