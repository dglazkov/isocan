 ...
 */
export declare function contributions<T>(pointId: string): Contribution<T>[];
/** What `isocan module ls` says about contributions that did not land. */
export declare function refusedContributions(): RefusedContribution[];
/**
 ...
 */
export declare function roundsOn(canvas: CanvasContents, item: Item): VoteRound[];
/** Is this round's clock still running — the curtain's half of it. */
export declare function roundRunning(round: VoteRound, nowMs: number): boolean;
/** Record where a runtime module's files are — a loader's act, once per load. */
export declare function registerModuleBase(name: string, base: string): void;
...
export declare function moduleBase(name: string): string | null;
 ...
 */
export declare function askTemplate(raw: {
    template?: unknown;
    args?: unknown;
}): {
    template?: string;
...
export declare const JUDGMENT_ROUTE = "/api/judgment";
/**
...
export declare function isDataOnly(manifest: ModuleManifest): boolean;
/**
