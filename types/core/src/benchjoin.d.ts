import type { BenchAgent } from "./bench.js";
 ...
 */
export declare const BENCH_JOIN_VERB = "join";
/**
 ...
 */
export declare function benchMentions(bench: readonly BenchAgent[], canvas: CanvasContents | null): BenchMention[];
/**
 ...
 */
export declare function benchJoinAsk(body: string, bench: readonly MentionCandidate[]): BenchJoinAsk | null;
/**
 ...
 */
export declare function benchJoinRefusal(name: string): string;
/**
 ...
 */
export declare function benchJoinWords(name: string): string;
