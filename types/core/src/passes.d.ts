 ...
 */
export declare const PASS_TTL_MS: number;
/**
 ...
 * `PASS_UNKNOWN`). */
export declare function parsePassToken(raw: string | undefined | null): PassToken | null;
/**
 ...
 */
export declare const passRoute: (canvasId: string, passId: string) => string;
/**
 ...
 * useless place.
 */
export type PassRefusal = typeof PASS_UNKNOWN | typeof PASS_SPENT | typeof PASS_EXPIRED | typeof PASS_MINTER_ENDED;
/**
 ...
 */
export declare const PASS_MINTER_ENDED = "pass-minter-ended";
/**
 ...
 */
export declare const PASS_UNKNOWN = "unknown-pass";
