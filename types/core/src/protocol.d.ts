...
export declare const CURRENT_CLIENT_FEATURES = "canvas-groups-v4,questionnaires-v1,design-requests-v1,design-requests-v2";
...
export declare const PARK_ADOPTED_CODE = "park-adopted";
/**
...
export declare const NO_RC_CODE = "no-rc";
...
export declare const NOT_YOUR_RC_CODE = "not-your-rc";
/**
 ...
 * from a break.*
 */
export declare const RENAMED_WIRE_KEYS: ReadonlyArray<readonly [now: string, before: string]>;
/**
 ...
 * this.
 */
export declare const STALE_CLIENT_CODE = "stale-client";
/**
 ...
 */
export declare const STALE_CLIENT_STATUS = 426;
...
export declare const WS_STALE_CLIENT = 4426;
/**
 ...
 */
export declare const WS_BEHIND = 4409;
...
export declare const FILENAME_HEADER = "X-Isocan-Filename";
/**
 ...
 */
export declare const MAX_DIRECT_UPLOAD_BYTES: number;
 ...
 */
export declare function healthPath(base: string): string;
/**
...
export declare const CANVASES_REACH_PARAM = "reach";
...
export declare function canvasesRoute(reach?: CanvasesReach): string;
/**
 ...
 * come here.
 */
export declare const HOMES_ROUTE = "/api/homes";
/**
 ...
 */
export declare const PRESENCE_WHERE_ROUTE = "/api/presence/where";
/**
...
export declare const ACTOR_KINDS_ROUTE = "/api/kinds";
 ...
 * that performs it.
 */
export declare const HOME_GC_ROUTE = "/api/gc";
