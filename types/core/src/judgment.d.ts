 ...
 */
export { JUDGMENT_ROUTE } from "./modules.js";
/** A question file bigger than this is refused before anything is asked. */
export declare const JUDGMENT_MAX_BYTES: number;
/** How many judgments one badge may ask for per minute — a flow is ~25 calls. */
export declare const JUDGMENT_PER_MINUTE = 60;
/** The home holds no key: nothing can be asked here. */
export declare const JUDGMENT_UNAVAILABLE = "judgment-unavailable";
/** The question file is over `JUDGMENT_MAX_BYTES`. */
export declare const JUDGMENT_TOO_LARGE = "judgment-too-large";
/** This badge has asked `JUDGMENT_PER_MINUTE` times in the last minute. */
export declare const JUDGMENT_RATE_LIMITED = "judgment-rate-limited";
/** The body is not a question file. */
export declare const JUDGMENT_BAD_REQUEST = "judgment-bad-request";
/** The judge refused or could not be reached; `error` says which, in its words. */
export declare const JUDGMENT_UPSTREAM = "judgment-upstream";
