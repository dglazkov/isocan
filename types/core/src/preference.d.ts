 ...
 */
export declare const PREFERRED_OVER_PROP = "preferredOver";
/** The items this one has been chosen over, oldest first. */
export declare function preferredOver(item: Item): string[];
/**
 ...
 */
export declare function preferPatch(winner: Item, loserIds: string[]): MetaPatch | null;
...
export declare function unpreferPatch(winner: Item, loserId: string): MetaPatch | null;
 ...
 */
export declare function preferences(canvas: CanvasContents): Preference[];
...
export declare function standings(canvas: CanvasContents): {
    itemId: string;
    won: number;
}[];
