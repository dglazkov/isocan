 ...
 */
export declare const ROLL_AWAY_MS: number;
/**
 ...
 */
export declare function rollDue(facts: {
 ...
 */
export declare function lastRoll(canvas: CanvasContents, actorId: string): {
    kind: RollKind;
    at: number;
} | null;
/**
 ...
 */
export declare function rollWords(kind: RollKind, name: string, listens: string): string;
/**
 ...
 */
export declare function rollOp(canvas: CanvasContents, kind: RollKind, body: string): Operation;
