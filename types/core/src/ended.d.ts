 ...
 */
export declare const BADGE_ENDED = "badge-ended";
...
export declare function badgeEndNotice(badgeId: string, at: string, operator: OperatorEnd | null): BadgeEnd;
/**
 ...
 */
export declare function endedSentence(end: {
    at: string;
    by: EndedBy;
    reason?: TakedownReason;
    address?: string;
 ...
 */
export declare const OPERATOR_END_ROUTE = "/api/operator/end/:target";
