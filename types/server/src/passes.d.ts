import { type PassRefusal } from "../../core/src/index.js";
import type { BadgeRecord, Desk, PassRecord } from "./desk.js";
/**
 ...
 */
export declare function mintPass(input: {
    canvasId: string;
    mintedBy: string;
    actorId?: string;
    now?: string;
 ...
 */
export declare class PassRefusedError extends Error {
    readonly code: PassRefusal;
    readonly status: number;
    constructor(code: PassRefusal, message: string);
}
/**
