...
| 21 Aug 2026 | [Canvas work log, 19–20 Aug](canvas-work-log-aug-19-20.md) · [full](https://claude.ai/code/artifact/f39676eb-ffa2-429d-8df2-b80bff5aaa6d) | Two days of shipping, with the reasoning kept: the isomorphism bug that renaming exposed, the forcing function added to stop it recurring, annotation as ink that knows what it is about, and why all of it fitted inside the existing op vocabulary. |
