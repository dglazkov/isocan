...
| research | [The night shift](docs/research/2026-08-24-the-night-shift.md) | 2026-08-29 | steps 1, 3 and 4 built — nightly grades (29 Aug), convergence (the fold), and on 3 Sep the converge lane one item wide (`scripts/converge-night.mjs`, its verdicts read by `isocan evals converge`); the morning comment and the diverge lane are open · see evals, personas |
