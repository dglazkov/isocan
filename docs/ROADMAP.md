...
| research | [Taking a deck somewhere else](docs/research/2026-09-04-deck-export.md) | 2026-09-04 | HTML deck, PDF (app print + CLI Chrome) and PNG-per-slide built 4 Sep; PPTX open after the PDF is used for a talk; Google Slides blocked on the per-user OAuth client · see inception, workbench |
