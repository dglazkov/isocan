...
- **2026-09-24** — Open: using or removing a screen does not rebuild the prototype; the Chat record and the CLI say so, but a person swapping a variation expects the prototype to follow.
