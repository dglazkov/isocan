...
note: designed 4 Sep from the research note's counts; phase 1 (the registries, the mind map as the first internal module) built the same night. Phases 2–5 designed and not built
---
