...
note: designed 4 Sep from the research note's counts; phases 1 (the registries, the mind map as the first internal module) and 2 (Mermaid, the first node-type module — the union paid) built the same night. Phases 3–5 designed and not built
---
