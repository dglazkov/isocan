...
Run by `scripts/persona-run.mjs` at `f0c565e`. **Nothing was changed.**

| Goal | Target | Now | Verdict |
| --- | --- | --- | --- |
| the entry chunk a first visit downloads | at most 747000 | 750401 (was 600420 on 2026-09-02) | **MISSED** |
| bytes past the last size somebody agreed to | at most 0 of 747000 | 3401 (was 0 on 2026-09-07) | **MISSED** |
