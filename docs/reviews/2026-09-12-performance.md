...
| Finding | Outcome |
| --- | --- |
| the entry chunk a first visit downloads is 657915, past 640000 | accepted — Dion, 20 Sep 2026. The goal moved 640000 → 747000 to meet the agreed ceiling, and every night above is under it. Same decision as the 15 and 16 September pages, applied to this night so the queue stops asking a question already settled. |
