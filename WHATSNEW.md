...
- Fanning out a deep stack is light now. The fan shows live documents for the newest 24 versions and a label for the rest, instead of loading every version at once.
