...
## Overview
Acme Field Notes is a small synthetic reading card with a working action.
...
## Layout
The card uses the 16px medium spacing step. Small 8px spacing is for the compact
