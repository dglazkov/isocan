...
const RUN_COMMAND: SlashCommand = {
  ...
  body: [
    ...
    "   who ran it.",
    "",
    "Read the program before you run it. It is a file on a canvas, which means",
    "anybody on this canvas could have written it — the fence bounds what it",
    "can reach (no network at all, one scratch directory, nothing of your home)",
    "and bounds nothing about whether running it was a good idea.",
    "",
