/** The on-demand procedure is shared by every design entrance, not copied into summons or skills. */
export const designWorkflowProcedure = `Design work on this canvas
