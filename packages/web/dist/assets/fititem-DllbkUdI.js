import{a4 as M,cH as y,B as l,aJ as g,ax as p,aL as E,du as S,aP as w}from"./index-B5TdiKfN.js";import{f as C}from"./fit-BYq6CrGJ.js";const T=2400,f={width:1280,height:800},u=e=>Math.max(80,Math.min(T,Math.round(e)));async function W(e,r,n){if(n.startsWith("image/")&&n!=="image/svg+xml"){const t=new Image;t.src=M(e,r);try{return await t.decode(),{width:u(t.naturalWidth),height:u(t.naturalHeight)}}catch{return f}}if(n==="text/html"||n==="image/svg+xml"){const t=await y(e,r).catch(()=>null);if(t===null)return f;const s=await z(t,n);if(s)return s}return f}const v=`<script>
