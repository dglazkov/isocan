import{a4 as M,dn as y,B as l,aG as g,aS as p,aI as E,e8 as S,aM as w}from"./index-mbJ_7eS_.js";import{f as C}from"./fit-BoTb8OWV.js";const I=2400,f={width:1280,height:800},m=e=>Math.max(80,Math.min(I,Math.round(e)));async function T(e,r,s){if(s.startsWith("image/")&&s!=="image/svg+xml"){const t=new Image;t.src=M(e,r);try{return await t.decode(),{width:m(t.naturalWidth),height:m(t.naturalHeight)}}catch{return f}}if(s==="text/html"||s==="image/svg+xml"){const t=await y(e,r).catch(()=>null);if(t===null)return f;const n=await W(t,s);if(n)return n}return f}const v=`<script>
