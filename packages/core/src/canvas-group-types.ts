import type { Actor, Item } from "./model.ts";
...
export type GroupAction =
  ...
  | { kind: "transform"; itemId: string; box: GroupBox; anchor?: GroupAnchor; expected: GroupExpectation[] }
  | { kind: "frame"; itemId: string; box?: GroupBox; fit?: boolean }
...
export type GroupWrite =
  | { kind: "patch"; itemId: string; fields: GroupFields }
